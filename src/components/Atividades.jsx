...
export default function Atividades({profile}){
  ...
  const currentList=tipoView?(arquivoView?arquivados:ativos).filter(i=>i.tipo===tipoView):[]
  const openTipo=(tipo,arquivo=false)=>{setTipoView(tipo);setArquivoView(arquivo)}
