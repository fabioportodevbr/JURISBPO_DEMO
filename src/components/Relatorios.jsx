...
export default function Relatorios({profile}){
  ...
  function formatValue(row,field){
    if(['valor_acao','valor_gasto','valor_economizado','valor_bruto','valor_restituido','custas','fgts','honorarios_sucumbenciais','honorarios_periciais','inss_reclamante','inss_reclamada','multa_inadimplemento','valor_assegurado','seguro_premio','total'].includes(field))return money(row[field])
